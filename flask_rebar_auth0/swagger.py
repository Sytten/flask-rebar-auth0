...
def register_authenticators(registry: HandlerRegistry):
    registry.swagger_generator.register_authenticator_converter(Auth0Authenticator, _convert_auth0_authenticator)
    registry.swagger_generator.register_authenticator_converter(Auth0AuthenticatorRBAC, _convert_auth0_authenticator_rbac)
